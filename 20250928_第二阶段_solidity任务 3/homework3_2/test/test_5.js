...
describe("Test upgrade", async function () {
  it("Should be able to deploy", async function () {
    ...
    await nftAuction.createAuction(
      ...
      // testERC721Address,
      // ethers.ZeroAddress,  // 如果用吃地址， 则报 Error: Transaction reverted: function call to a non-contract account
      // address(0),    // 如果用吃地址， 则报 ,ReferenceError: address is not defined
      1
    );
