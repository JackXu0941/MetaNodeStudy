...
contract NftAuction is Initializable{
    ...
    function getChainlinkDataFeedLatestAnswer(
        ...
        console.log("priceFeed_Address ---------:",tokenAddress );
        // console.log("priceFeed_Address ---------:",priceFeeds[tokenAddress] );
        // prettier-ignore
        (
            /* uint80 roundId */,
            int256 answer,
     ...
     function test111(
        AggregatorV3Interface tokenAddress
    ) public view returns (int) {
        AggregatorV3Interface priceFeed = tokenAddress;
        // console.log("priceFeed_Address ---------:",tokenAddress );
        // console.log("priceFeed_Address ---------:",priceFeeds[tokenAddress] );
        // prettier-ignore
        (
    ...
    function placeBid(
        ...
        if (_tokenAddress != address(0)) {
            ...
            console.log("usdc feedprice---------:", uint(getChainlinkDataFeedLatestAnswer(_tokenAddress)));
            console.log("usdc payValue ---------:",payValue );
            ...
            console.log("ETH feedprice---------:", uint(getChainlinkDataFeedLatestAnswer(address(0))) );
            console.log("usdc payValue ---------:",payValue );
